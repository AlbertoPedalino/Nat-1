...
const TOOLS = [
  ...
  { path: REGISTRY_META.gb_board_registry.newRoute, label: 'GM Board', desc: 'HEXcrawl, dungeons, quests, tables', icon: LayoutDashboard, color: '#e67e22', borderColor: 'rgba(230,126,34,0.3)' },
